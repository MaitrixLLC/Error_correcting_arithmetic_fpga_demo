...
#set_location_assignment PIN_G28 -to ddr3_a[13]	#uncomment this statement if you are upgrading the SDRAM to higher capacity
...
set_instance_assignment -name IO_STANDARD "SSTL-15 CLASS I" -to ddr3_ck_p
set_instance_assignment -name OUTPUT_TERMINATION "SERIES 50 OHM WITHOUT CALIBRATION" -to ddr3_ck_p
set_instance_assignment -name IO_STANDARD "SSTL-15 CLASS I" -to ddr3_ck_n
set_instance_assignment -name OUTPUT_TERMINATION "SERIES 50 OHM WITHOUT CALIBRATION" -to ddr3_ck_n
set_instance_assignment -name IO_STANDARD "SSTL-15 CLASS I" -to ddr3_dqs_p
set_instance_assignment -name IO_STANDARD "SSTL-15 CLASS I" -to ddr3_dqs_n
#########################################################################################################
...
#set_instance_assignment -name INPUT_TERMINATION "PARALLEL 50 OHM WITH CALIBRATION" -to ddr3_dqs_p
...
#set_instance_assignment -name INPUT_TERMINATION "PARALLEL 50 OHM WITH CALIBRATION" -to ddr3_dqs_n
...
set_instance_assignment -name DQ_GROUP 9 -from ddr3_dqs_p[3] -to ddr3_dq[0]
