...
foreach { inst } $instances {
	...
	set local_pll_afi_phy_clk [ q_sys_mem_if_ddr3_emif_0_p0_get_or_add_clock_vseries \
		...
		-suffix "afi_phy_clk" \
		-source $pll_ref_clock \
		-multiply_by $::GLOBAL_q_sys_mem_if_ddr3_emif_0_p0_pll_mult(PLL_HR_CLK) \
		-divide_by $::GLOBAL_q_sys_mem_if_ddr3_emif_0_p0_pll_div(PLL_HR_CLK) \
		-phase $::GLOBAL_q_sys_mem_if_ddr3_emif_0_p0_pll_phase(0) ]
	...
	set mem_factor [expr double($::GLOBAL_q_sys_mem_if_ddr3_emif_0_p0_pll_mult(PLL_MEM_CLK)) / $::GLOBAL_q_sys_mem_if_ddr3_emif_0_p0_pll_div(PLL_MEM_CLK)]
	set avl_factor [expr double($::GLOBAL_q_sys_mem_if_ddr3_emif_0_p0_pll_mult(PLL_NIOS_CLK)) / $::GLOBAL_q_sys_mem_if_ddr3_emif_0_p0_pll_div(PLL_NIOS_CLK)]
	...
	# Half-rate clock
	set local_pll_hr_clock [ q_sys_mem_if_ddr3_emif_0_p0_get_or_add_clock_vseries \
		-target $pll_hr_clock \
		-suffix "hr_clk" \
		-source $pll_ref_clock \
		-multiply_by $::GLOBAL_q_sys_mem_if_ddr3_emif_0_p0_pll_mult(PLL_HR_CLK) \
		-divide_by $::GLOBAL_q_sys_mem_if_ddr3_emif_0_p0_pll_div(PLL_HR_CLK) \
		-phase $::GLOBAL_q_sys_mem_if_ddr3_emif_0_p0_pll_phase(PLL_HR_CLK) ]	
	...
	if {$::GLOBAL_q_sys_mem_if_ddr3_emif_0_p0_pll_phase(PLL_HR_CLK) >= 180} {
		set_multicycle_path -from [get_clocks $local_pll_hr_clock] -to [get_clocks $local_pll_afi_phy_clk] 2
	}

	set hr_clk_addr_clk_diff [expr $::GLOBAL_q_sys_mem_if_ddr3_emif_0_p0_pll_phase(PLL_HR_CLK) - $::GLOBAL_q_sys_mem_if_ddr3_emif_0_p0_pll_phase(PLL_ADDR_CMD_CLK)]
