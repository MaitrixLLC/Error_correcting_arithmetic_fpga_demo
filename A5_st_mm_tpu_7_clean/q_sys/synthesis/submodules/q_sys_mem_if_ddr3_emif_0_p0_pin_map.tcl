...
proc q_sys_mem_if_ddr3_emif_0_p0_get_dqs_period { dqs_pins } {
	set dqs_period -100
	set dqs0 [lindex $dqs_pins 0]
	if {$dqs0 != ""} {
		set dll_id [q_sys_mem_if_ddr3_emif_0_p0_traverse_to_dll_id $dqs0 msg_list]
		if {$dll_id != -1} {
...
proc q_sys_mem_if_ddr3_emif_0_p0_get_ddr_pins { instname allpins } {
	...
	set pll_hr_clock_id [q_sys_mem_if_ddr3_emif_0_p0_get_output_clock_id $pins(hr_ck_pins) "Half-Rate CK" msg_list]
	if {$pll_hr_clock_id == -1} {
		foreach {msg_type msg} $msg_list {
			post_message -type $msg_type "q_sys_mem_if_ddr3_emif_0_p0_pin_map.tcl: $msg"
		}
		post_message -type critical_warning "q_sys_mem_if_ddr3_emif_0_p0_pin_map.tcl: Failed to find PLL clock for pins [join $pins(hr_ck_pins)]"
	} else {
		set pll_hr_clock [q_sys_mem_if_ddr3_emif_0_p0_get_pll_clock_name $pll_hr_clock_id]
	}
