...
## External clocks
create_clock -name {clkintop_100_p} -period 10.00 [ get_ports clkintop_100_p]
...
create_clock -name {data1_38} -period 6.0 -waveform {0 3.01} {q_sys:u0|q_sys_mSGDMA_0:msgdma_0|altera_avalon_st_pipeline_stage:agent_pipeline_006|altera_avalon_st_pipeline_base:core|data1[38]}
...
create_generated_clock -name slow_clk -source { u0|pll_0|altera_pll_i|general[0].gpll~PLL_OUTPUT_COUNTER|divclk }  -divide_by 32 {*|master_driver_msgdma_0|slow_clk_int[4]}
