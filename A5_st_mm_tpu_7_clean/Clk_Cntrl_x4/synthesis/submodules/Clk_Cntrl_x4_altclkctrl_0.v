//altclkctrl CBX_SINGLE_OUTPUT_FILE="ON" CLOCK_TYPE="Global Clock" DEVICE_FAMILY="Arria V" USE_GLITCH_FREE_SWITCH_OVER_IMPLEMENTATION="OFF" clkselect ena inclk outclk
...
module  Clk_Cntrl_x4_altclkctrl_0_sub
	( 
	clkselect,
	ena,
	inclk,
...
`endif
	...
	assign
		...
		inclk_wire = {inclk},
		outclk = wire_sd1_outclk;
endmodule //Clk_Cntrl_x4_altclkctrl_0_sub
...
`timescale 1 ps / 1 ps
// synopsys translate_on
module  Clk_Cntrl_x4_altclkctrl_0  (
    clkselect,
    inclk0x,
    inclk1x,
    inclk2x,
...
`endif
    ...
    Clk_Cntrl_x4_altclkctrl_0_sub  Clk_Cntrl_x4_altclkctrl_0_sub_component (
                .clkselect (clkselect),
                .ena (sub_wire1),
                .inclk (sub_wire3),
                .outclk (sub_wire0));
